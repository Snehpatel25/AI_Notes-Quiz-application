...
export const getGlossaryTerms = async (content) => {
  ...
  try {
    const { data } = await axios.post(`${API_BASE_URL}/ai/glossary`, { content });
...
export const generateSummary = async (content) => {
  ...
  try {
    const { data } = await axios.post(`${API_BASE_URL}/ai/summary`, { content });
    return data?.summary || '';
  } catch (error) {
...
export const generateTags = async (content) => {
  ...
  try {
    const { data } = await axios.post(`${API_BASE_URL}/ai/tags`, { content });
...
export const checkGrammar = async (content) => {
  ...
  try {
    const { data } = await axios.post(`${API_BASE_URL}/ai/grammar`, { content });
    return Array.isArray(data) ? data : [];
  } catch (error) {
...
export const extractActionItems = async (content) => {
  ...
  try {
    const { data } = await axios.post(`${API_BASE_URL}/ai/actions`, { content });
    return Array.isArray(data) ? data : [];
  } catch (error) {
...
export const analyzeSentiment = async (content) => {
  ...
  try {
    const { data } = await axios.post(`${API_BASE_URL}/ai/sentiment`, { content });
...
export const generateQuiz = async (params) => {
  ...
  try {
    const { data } = await axios.post(`${API_BASE_URL}/ai/quiz/generate`, params);
...
export const getQuizHint = async (question, subject) => {
  ...
  try {
    const { data } = await axios.post(`${API_BASE_URL}/ai/quiz/hint`, { question, subject });
...
export const chatWithNote = async (content, query) => {
  ...
  try {
    const { data } = await axios.post(`${API_BASE_URL}/ai/chat`, { content, query });
