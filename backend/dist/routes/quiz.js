...
import { createQuiz, submitQuiz, getQuizHistory, getQuizById, getHint, } from '../services/quizService.js';
...
router.post('/generate', async (req, res) => {
    try {
        ...
        const quiz = await createQuiz(req.userId, subject, gradeLevel, topic, numQuestions || 10);
        res.json(quiz);
    }
    catch (error) {
